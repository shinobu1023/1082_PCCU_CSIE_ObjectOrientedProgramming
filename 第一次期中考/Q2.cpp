...
/* 本題重點：private、set function、get function */
...
int main()
{
    ...
    // 將四個物件根據題目要求格式輸出
    cout << employee1.getPosition() << "-" << employee1.getName() << " " << employee1.getIncome() << endl;
    cout << employee2.getPosition() << "-" << employee2.getName() << " " << employee2.getIncome() << endl;
    cout << employee3.getPosition() << "-" << employee3.getName() << " " << employee3.getIncome() << endl;
    cout << employee4.getPosition() << "-" << employee4.getName() << " " << employee4.getIncome() << endl;
